...
public class MozosController {
    ...
    public void initialize() {
        // Crear el menú contextual una sola vez
        menuMesa = new ContextMenu();

        MenuItem verPedido = new MenuItem("Ver consumo");
        MenuItem abrirMesa = new MenuItem("Abrir mesa");
        MenuItem agregarPedido = new MenuItem("Agregar item a pedido");
        MenuItem eliminarItem = new MenuItem("Eliminar item de pedido");

        menuMesa.getItems().addAll(verPedido, abrirMesa, agregarPedido, eliminarItem);
    ...
    public void setRestaurante(Restaurante restaurante) {
        ...
        inicializarMesas(); // 👈 ahora que ya no es null
    }
    ...
    private void actualizarVisualMesa(Button boton, Mesa mesa) {
        ...
        // El botón tiene 2 labels: [“Mesa X”, “Disponible/Ocupada”]
        ...
        // Si el botón no tiene un VBox gráfico, lo reconstruimos (por si acaso)
        else {
    ...
    private void eliminarItemDePedido(Mesa mesa) {
        ...
        // 1️⃣ Crear tabla con los ítems del consumo
    ...
    private void agregarAlPedido(Mesa mesa) {
        ...
        // 1️⃣ Obtener y ordenar los ítems del restaurante
        ...
        // 3️⃣ Campo para ingresar cantidad
    ...
    private void cerrarSesion() {
        try {
            ...
            helloController.setRestaurante(miRestaurante); // <-- PASAMOS EL MISMO RESTAURANTE
